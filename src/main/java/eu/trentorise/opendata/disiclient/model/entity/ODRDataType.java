...
public class ODRDataType {
    ...
    DataType convertDataType(String dataType) {
        ...
        if (dataType.equals(ODRDataType.STRING)) {
            return DataType.STRING;
        }
        if (dataType.equals(ODRDataType.SSTRING)) {
            return DataType.SSTRING;
        }
        if (dataType.equals(ODRDataType.BOOLEAN)) {
            return DataType.BOOLEAN;
        }
        if (dataType.equals(ODRDataType.COMPLEX_TYPE)) {
            return DataType.COMPLEX_TYPE;
        }

        if (dataType.equals(ODRDataType.CONCEPT)) {
            return DataType.CONCEPT;
        }
        if (dataType.equals(ODRDataType.DATE)) {
            return DataType.DATE;
        }
        if (dataType.equals(ODRDataType.FLOAT)) {
            return DataType.FLOAT;
        }
        if (dataType.equals(ODRDataType.INTEGER)) {
            return DataType.INTEGER;
        }
        if (dataType.equals(ODRDataType.LONG)) {
            return DataType.LONG;
        }
        if (dataType.equals(ODRDataType.NLSTRING)) {
