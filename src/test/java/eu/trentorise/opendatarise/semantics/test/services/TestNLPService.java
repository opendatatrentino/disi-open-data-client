...
public class TestNLPService {
	...
	public void testMultiWord() {
		...
		ISemanticText mwOdrText = new SemanticText(nlpService.runNLP("Seggiovia ad agganciamento automatico"));

		assertEquals(mwOdrText.getSentences().get(0).getWords().size(), 1);

		IWord odrToken = mwOdrText.getSentences().get(0).getWords().get(0);
