 ...
 * @since 0.11.1
 */
// Maybe in the future we can use it to generate reports
public class DisiClientTestRunner extends JUnitParamsRunner {   
    ...
    public DisiClientTestRunner (Class<?> klass) throws InitializationError {
        super(klass);
    }
